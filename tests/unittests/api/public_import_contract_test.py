...
def test_top_level_exports_construct_the_public_state() -> None:
    ...
    hydrogen_alloy_model = MaFeSiOHLiquid()
    ...
    hydrogen_alloy = solution_state(hydrogen_alloy_model, 2350.0, 1.0e5, [0.68, 0.08, 0.04, 0.2])
    ...
    assert isinstance(hydrogen_alloy, SolutionState)
    assert hydrogen_alloy.lngamma.shape == (4,)
